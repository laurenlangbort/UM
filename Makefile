...
LDLIBS = -lcii40-O2 -lnetpbm -lcii40 -lm -lrt 
...
testing_main: testing_main.o um_memory.o bitpack.o \
			  execution_cycle.o instructions.o um_read.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

writetests: umlabwrite.o instruction_tests.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
